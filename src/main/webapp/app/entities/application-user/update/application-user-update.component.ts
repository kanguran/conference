...
export class ApplicationUserUpdateComponent implements OnInit {
  ...
  protected updateForm(applicationUser: IApplicationUser): void {
    ...
    this.usersSharedCollection = this.userService.addUserToCollectionIfMissing<IUser>(this.usersSharedCollection, applicationUser.appUser);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.userService
      ...
      .pipe(map((users: IUser[]) => this.userService.addUserToCollectionIfMissing<IUser>(users, this.applicationUser?.appUser)))
