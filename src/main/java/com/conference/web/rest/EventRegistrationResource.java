...
public class EventRegistrationResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(EventRegistrationResource.class);
    ...
    public ResponseEntity<EventRegistrationDTO> createEventRegistration(@Valid @RequestBody EventRegistrationDTO eventRegistrationDTO)
        ...
        eventRegistrationDTO = eventRegistrationService.save(eventRegistrationDTO);
        return ResponseEntity.created(new URI("/api/event-registrations/" + eventRegistrationDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, eventRegistrationDTO.getId().toString()))
    ...
    public ResponseEntity<EventRegistrationDTO> updateEventRegistration(
        ...
        eventRegistrationDTO = eventRegistrationService.update(eventRegistrationDTO);
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<EventRegistrationDTO> getEventRegistration(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteEventRegistration(@PathVariable("id") Long id) {
